# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-09 22:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inherit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='heirs', to='workflow.Context')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
